...
import { LayoutDashboard, Users, Skull, TrendingDown, Swords, CalendarDays, Shield, Eye } from 'lucide-react'
  ...
  return (
    <aside className="flex-shrink-0 w-56 flex flex-col bg-ctp-mantle border-r border-ctp-surface0 overflow-hidden">
      ...
      <div className="px-3 pb-3 flex-shrink-0">
        <div className="bg-ctp-surface0/50 rounded-xl p-3 border border-ctp-surface1/50">
          <div className="flex items-center gap-2 mb-2">
            <Eye className="w-3 h-3 text-ctp-overlay1 flex-shrink-0" />
            <p className="text-[10px] font-mono text-ctp-overlay1 uppercase tracking-wide">Colour mode</p>
          </div>
