...
COOLDOWN_RULES = [
    ...
    ("personal_spec", "DemonHunter", 203720, "Demon Spikes", 15, 6),
    ("personal_spec", "DemonHunter", 187827, "Metamorphosis", 240, 15),
    ("personal_spec", "DemonHunter", 204021, "Fiery Brand", 60, 8),
    ...
    ("personal", "Warrior", 202168, "Impending Victory", 30, 1),
...
COOLDOWN_REQUIRED_TALENT_SPELL_IDS = {
    ...
    118038: [118038], 184364: [184364], 202168: [202168], 51052: [51052], 196718: [196718],
