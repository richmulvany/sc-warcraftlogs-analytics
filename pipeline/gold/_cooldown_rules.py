...
COOLDOWN_RULE_RECORDS: tuple[CooldownRuleRecord, ...] = (
    ...
    CooldownRuleRecord(
        "personal", "DeathKnight", 49039, "Lichborne", 120, 10, required_talent_spell_ids=(49039,)
    ),
    CooldownRuleRecord(
        "personal", "DeathKnight", 48743, "Death Pact", 120, 1, required_talent_spell_ids=(48743,)
    ),
    CooldownRuleRecord(
        "personal", "DemonHunter", 198589, "Blur", 60, 10, allowed_spec_ids=(577, 1480)
    ),
    CooldownRuleRecord(
        "personal",
        "DemonHunter",
    ...
    CooldownRuleRecord(
        ...
        180,
        6,
        required_talent_spell_ids=(264735,),
    ),
    CooldownRuleRecord("personal", "Hunter", 109304, "Exhilaration", 120, 1),
    CooldownRuleRecord("personal", "Mage", 45438, "Ice Block", 240, 10),
    CooldownRuleRecord(
        "personal", "Mage", 342245, "Alter Time", 60, 10, required_talent_spell_ids=(342245,)
    ),
    CooldownRuleRecord(
        "personal", "Mage", 55342, "Mirror Image", 120, 40, required_talent_spell_ids=(55342,)
    ),
    CooldownRuleRecord(
        "personal",
        "Mage",
        ...
        120,
        3,
        required_talent_spell_ids=(110959,),
    ),
    CooldownRuleRecord("personal", "Monk", 115203, "Fortifying Brew", 360, 15),
    CooldownRuleRecord(
        "personal", "Monk", 122783, "Diffuse Magic", 90, 6, required_talent_spell_ids=(122783,)
    ),
    CooldownRuleRecord(
        "personal", "Monk", 122278, "Dampen Harm", 120, 10, required_talent_spell_ids=(122278,)
    ),
    CooldownRuleRecord(
        "personal",
        "Monk",
        ...
        90,
        10,
        allowed_spec_ids=(269,),
        required_talent_spell_ids=(122470,),
    ),
    CooldownRuleRecord("personal", "Paladin", 642, "Divine Shield", 300, 8),
    CooldownRuleRecord(
        "personal", "Paladin", 498, "Divine Protection", 60, 8, allowed_spec_ids=(65,)
    ),
    CooldownRuleRecord(
        "personal", "Paladin", 184662, "Shield of Vengeance", 90, 10, allowed_spec_ids=(70,)
    ),
    CooldownRuleRecord(
        "personal", "Priest", 19236, "Desperate Prayer", 90, 10, required_talent_spell_ids=(19236,)
    ),
    ...
    CooldownRuleRecord(
        "personal", "Warlock", 108416, "Dark Pact", 60, 20, required_talent_spell_ids=(108416,)
    ),
    CooldownRuleRecord(
        "personal",
        "Warrior",
        ...
        8,
        allowed_spec_ids=(71,),
        required_talent_spell_ids=(118038,),
    ),
    CooldownRuleRecord(
        "personal",
        "Warrior",
        ...
        8,
        allowed_spec_ids=(72,),
        required_talent_spell_ids=(184364,),
    ),
    CooldownRuleRecord(
        "personal",
        "Warrior",
        ...
        30,
        1,
        required_talent_spell_ids=(202168,),
    ),
    CooldownRuleRecord(
    ...
    CooldownRuleRecord(
        "personal_spec", "Warrior", 871, "Shield Wall", 240, 8, allowed_spec_ids=(73,)
    ),
    CooldownRuleRecord(
        "personal_spec", "Warrior", 12975, "Last Stand", 180, 15, allowed_spec_ids=(73,)
    ),
    CooldownRuleRecord(
        "raid", "DeathKnight", 51052, "Anti-Magic Zone", 120, 10, required_talent_spell_ids=(51052,)
    ),
    CooldownRuleRecord(
        "raid", "DemonHunter", 196718, "Darkness", 300, 8, required_talent_spell_ids=(196718,)
    ),
    CooldownRuleRecord(
        "raid", "Evoker", 374227, "Zephyr", 120, 8, required_talent_spell_ids=(374227,)
    ),
    CooldownRuleRecord(
        "raid",
        "Paladin",
        ...
        8,
        allowed_spec_ids=(65,),
        required_talent_spell_ids=(31821,),
    ),
    CooldownRuleRecord(
        "raid",
        "Priest",
        ...
        180,
        10,
        allowed_spec_ids=(256,),
        required_talent_spell_ids=(62618,),
    ),
    CooldownRuleRecord(
        "raid",
        "Shaman",
        ...
        180,
        6,
        allowed_spec_ids=(264,),
        required_talent_spell_ids=(98008,),
    ),
    ...
    CooldownRuleRecord(
        ...
        90,
        12,
        allowed_spec_ids=(105,),
        required_talent_spell_ids=(102342,),
    ),
    CooldownRuleRecord(
        "external",
        "Evoker",
        ...
        60,
        8,
        allowed_spec_ids=(1468,),
        required_talent_spell_ids=(357170,),
    ),
    CooldownRuleRecord(
        "external",
        "Monk",
        ...
        120,
        12,
        allowed_spec_ids=(270,),
        required_talent_spell_ids=(116849,),
    ),
    CooldownRuleRecord(
        "external",
        "Paladin",
        ...
        12,
        allowed_spec_ids=(65,),
        required_talent_spell_ids=(6940,),
    ),
    CooldownRuleRecord(
        "external",
        "Priest",
        ...
        8,
        allowed_spec_ids=(256,),
        required_talent_spell_ids=(33206,),
    ),
    CooldownRuleRecord(
        "external",
        "Priest",
        ...
        180,
        10,
        allowed_spec_ids=(257,),
        required_talent_spell_ids=(47788,),
    ),
)
...
COOLDOWN_ALLOWED_SPECS = {
    rule.ability_id: list(rule.allowed_spec_ids)
    for rule in COOLDOWN_RULE_RECORDS
    if rule.allowed_spec_ids
}
...
DEFENSIVE_ABILITY_ID_TO_NAME = {
    rule.ability_id: rule.ability_name for rule in COOLDOWN_RULE_RECORDS
}
DEFENSIVE_ABILITY_NAMES = sorted(
    rule.ability_name.lower() for rule in PERSONAL_DEFENSIVE_RULE_RECORDS
)
...
def _cooldown_rule_sql_rows(
    rules: tuple[CooldownRuleRecord, ...], *, include_category: bool
) -> str:
    rows: list[str] = []
    for rule in rules:
