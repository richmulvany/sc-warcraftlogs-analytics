...
FRONTEND_TABLES: dict[str, str] = {
    ...
    "gold_wipe_survival_discipline.csv": "gold_wipe_survival_discipline",
    ...
    "gold_player_survivability_rankings.csv": "gold_player_survivability_rankings",
    ...
    "gold_preparation_readiness.csv": "gold_preparation_readiness",
